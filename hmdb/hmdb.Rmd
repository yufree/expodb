...
```{python}
hmdbextract('hmdb/hmdb_metabolites.xml','hmdb/hmdb.csv')
hmdbpextract('hmdb/hmdb_metabolites.xml','hmdb/hmdbpathway.csv')
```
...
hmdbextract('hmdb/serum_metabolites.xml','hmdb/serumhmdb.csv')
...
write.csv(omim,file = 'hmdb/hmdbomim.csv')
write.csv(dname,file = 'hmdb/hmdbdname.csv')
write.csv(protein,file = 'hmdb/hmdbprotein.csv')
write.csv(smpdb,file = 'hmdb/hmdbsmpdb.csv')
write.csv(keggmap,file = 'hmdb/hmdbkeggmap.csv')
write.csv(uniprot,file = 'hmdb/hmdbuniprot.csv')
write.csv(gene,file = 'hmdb/hmdbgene.csv')
write.csv(protein_type,file = 'hmdb/hmdbprotein_type.csv')
```
